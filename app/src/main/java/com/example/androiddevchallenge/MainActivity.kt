...
import com.example.androiddevchallenge.ui.navigation.LocalBackDispatcher
...
class MainActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		setContent {
			PetAdoptionTheme {
				AdoptionApp(onBackPressedDispatcher)
			}
		}
	}
}
...
@Composable
fun AdoptionApp(backDispatcher: OnBackPressedDispatcher) {
