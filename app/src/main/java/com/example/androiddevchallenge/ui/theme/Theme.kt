...
private val LightColorPalette = PetAdoptionColors(
	brand = Shadow5,
...
private val DarkColorPalette = PetAdoptionColors(
	brand = Shadow1,
...
object PetAdoptionTheme {
	val colors: PetAdoptionColors
		@Composable
		get() = LocalPetAdoptionColors.current
}

@Stable
class PetAdoptionColors(
	...
	fun update(other: PetAdoptionColors) {
...
@Composable
fun PetAdoptionColors(
	colors: PetAdoptionColors,
	content: @Composable () -> Unit
) {
	val colorPalette = remember { colors }
	colorPalette.update(colors)
	CompositionLocalProvider(LocalPetAdoptionColors provides colorPalette, content = content)
}

private val LocalPetAdoptionColors = staticCompositionLocalOf<PetAdoptionColors> {
	error("No PetAdoptionColorPalette provided")
}

fun debugColors(
	darkTheme: Boolean,
	debugColor: Color = Color.Cyan
) = Colors(
	primary = debugColor,
